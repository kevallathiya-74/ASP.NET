<%@ Page Title="" Language="C#" MasterPageFile="~/Extra/C2.Master" AutoEventWireup="true" CodeBehind="P5.aspx.cs" Inherits="_230801347.Ch4.P5" %>
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-card login-card">
            ...
            <div class="input-field">
                ...
                <asp:TextBox ID="txtLoginUser" runat="server"
                    CssClass="auth-input" Placeholder="Username" AutoPostBack="True" OnTextChanged="txtLoginUser_TextChanged"></asp:TextBox>
            </div>
            ...
            <asp:Button ID="btnLogin" runat="server"
                Text="LOGIN" CssClass="auth-btn" ValidationGroup="Valid4" OnClick="btnLogin_Click" />
        ...
        <div class="auth-card">
            ...
            <asp:Button ID="btnSignup" runat="server"
                Text="CREATE ACCOUNT" CssClass="auth-btn" ValidationGroup="Valid5" OnClick="btnSignup_Click" />
